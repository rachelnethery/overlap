...
hout<-read.csv('data/leukemia.csv')
...
## create an empty table to store leukemia analysis results ##
results_tab<-NULL

#############################################
## outcome is 2014 leukemia mortality rate ##
#############################################
...
## estimate causal effect of exposure on leukemia using trimmed BART ##
test3<-test2
...
############################################################
## outcome is change in leukemia mortality rate 1980-2014 ##
############################################################
